...
namespace cookhatAPI.Interface
{
    public interface IRecipe
    {
        ...
        List<RecipeDetail> GetRecipeSearchList(string recipesearch,string ingredient,string category,string cusisinetype);
        List<RecipeChef> GetSimilarRecipeList();
        List<string> GetCuisineSearchList();
    }
}
